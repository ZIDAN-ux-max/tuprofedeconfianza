# -*- coding: utf-8 -*-
"""Pagina de Chat: aqui es donde el alumno conversa con el tutor. Usa
...
def mostrar_chat(usuario, modo, curso_elegido=None):
    ...
    st.markdown(
        ...
        f"<span style='font-size:1.1em; color:rgba(255,255,255,0.7)'>"
        f"Estudiando: <strong style='color:#00C9FF'>{emoji_modo} {modo}</strong>"
        f"</span></div>",
